 ...
 * @param {MaalingStep[]} steps - The array of Sak steps.
 * @param {MaalingStep} currentStep - The current Sak step.
...
const useMaalingForm = (
  ...
  const [steps, setSteps] = useState<MaalingStep[]>(startedSakSteps);
