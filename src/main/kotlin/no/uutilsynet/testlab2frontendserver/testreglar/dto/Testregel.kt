...
fun List<TestregelDTO>.toTestregelList(
  ...
  return this.map { testregelDTO ->
    Testregel(
        ...
        krav = kravMap[testregelDTO.kravId]
                ?: throw IllegalArgumentException(
                    "Krav med id ${testregelDTO.kravId} finns ikkje for testregel id  ${testregelDTO.id}"),
        ...
        spraak = testregelDTO.spraak ?: TestlabLocale.nb,
